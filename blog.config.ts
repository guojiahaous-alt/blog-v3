...
const basicConfig = {
	title: '郭雨博',
	subtitle: '别人越是想看我倒下 这越是我坚持的理由',
	// 长 description 利好于 SEO
	description: '郭雨博的个人博客，分享技术与生活。“折腾不止，摸鱼生活——摸门🙏🏻”。这个博客记录了他在生活和技术学习中的点滴经历，充满启发与思考。网站界面简洁美观，内容丰富实用，人气互动活跃，涵盖了编程、生活、学习等多个领域，为读者提供了卓越的阅读体验。',
	author: {
		name: '郭雨博',
		avatar: 'https://img.guoyubo.cn/img/Image-10-43-28.png',
	...
	favicon: 'https://img.guoyubo.cn/img/Image-10-43-28.png',
	language: 'zh-CN',
